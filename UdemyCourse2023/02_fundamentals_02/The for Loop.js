...
//A ciklus iterációs változója nem egy, hanem több is lehet.
//Ebben az esetben minden változót a megfelelő blokkba írunk, vesszővel elválasztva.
for (let i = 0, j = 10; i <= j; i++, j--) {
  console.log(`i= ${i} , j= ${j}`);
}

//first block is not filled,
//this i variable will be used int he loop
let i = 0;
for (; i < 3; i++) {
  console.log(i);
}
